(() => {
    ...
    (() => {
        ...
        !function(t, e) {
            ...
            var K = {
                ...
                j("inspectSource", (function(t) {
                    ...
                    r(n).source = i.join("string" == typeof e ? e : "")), t !== a ? (s ? !l && t[e] && (c = !0) : delete t[e], 
                ...
                return function(a, c, l, u) {
                    for (var f, h, d = zt(a), p = b(d), v = Lt(c, l, 3), g = st(p.length), y = 0, m = u || Nt, x = e ? m(a, g) : r ? m(a, 0) : void 0; g > y; y++) if ((s || y in p) && (h = v(f = p[y], y, d), 
                    t)) if (e) x[y] = h; else if (h) switch (t) {
                      case 3:
                        return !0;
            ...
            var Qt = Object.keys || function(t) {
                ...
                return t;
            }, Jt = et("document", "documentElement"), Zt = X("IE_PROTO"), te = function() {}, ee = function() {
                ...
                var r;
                return null !== t ? (te.prototype = R(t), r = new te, te.prototype = null, r[Zt] = t) : r = ee(), 
                void 0 === e ? r : Kt(r, e);
            };
            H[Zt] = !0;
            ...
            null == oe && (oe = {}), S(oe, pe) || C(oe, pe, (function() {
                return this;
            }));
            var ge = {
                IteratorPrototype: oe,
                BUGGY_SAFARI_ITERATORS: ve
            }, be = M.f, ye = Wt("toStringTag"), me = function(t, e, r) {
                ...
                if (b && (a = de(b.call(new t)), Se !== Object.prototype && a.next && (de(a) !== Se && (we ? we(a, Se) : "function" != typeof a[ke] && C(a, ke, Ae)), 
                me(a, f, !0))), "values" == n && v && "values" !== v.name && (h = !0, g = function() {
                    return v.call(this);
                }), p[ke] !== g && C(p, ke, g), le[e] = g, n) if (c = {
                    values: u("values"),
                    keys: o ? g : u("keys"),
                    entries: u("entries")
                }, s) for (l in c) !Oe && !h && l in p || J(p, l, c[l]); else At({
                    target: e,
                    proto: !0,
                    forced: Oe || h
                }, c);
            ...
            var _e = Object.assign, Me = !_e || c((function() {
                ...
                for (var r = zt(t), i = arguments.length, n = 1, o = vt.f, s = h.f; i > n; ) for (var a, c = b(arguments[n++]), u = o ? Qt(c).concat(o(c)) : Qt(c), f = u.length, d = 0; f > d; ) a = u[d++], 
            ...
            var De = "\t\n\v\f\r                　\u2028\u2029\ufeff", Pe = "[" + De + "]", Fe = RegExp("^" + Pe + Pe + "*"), Ve = RegExp(Pe + Pe + "*$"), Xe = function(t) {
                return function(e) {
                    var r = String(y(e));
                ...
                trim: Xe(3)
            }.trim, qe = a.parseInt, $e = /^[+-]?0[Xx]/, Ye = 8 !== qe(De + "08") || 22 !== qe(De + "0x16") ? function(t, e) {
                var r = He(String(t));
            ...
            var Ze = function(t, e, r) {
                ...
                H[r] = !0;
            })), rr = (er.REQUIRED, er.fastKey, er.getWeakData, er.onFreeze, Wt("iterator")), ir = Array.prototype, nr = Wt("iterator"), or = function(t, e, r, i) {
                try {
            ...
            var hr = function(t, e, r, i, n) {
                ...
                if (Ot(t, "function" != typeof o || !(n || s.forEach && !c((function() {
                    ...
                    }))).prototype = s, s.constructor = l), (v || b) && (h("delete"), h("has"), i && h("get")), 
                    (b || p) && h(u), n && s.clear && delete s.clear;
                }
                return f[t] = l, At({
                    global: !0,
                    forced: l != o
            ...
            function qr(t, e, r) {
                ...
                return e = Yr(e) || 0, $r(r) && (u = !!r.leading, o = (f = "maxWait" in r) ? Vr(Yr(r.maxWait) || 0, e) : o, 
                h = "trailing" in r ? !!r.trailing : h), b.cancel = function() {
            ...
            var Gr = function(t, e, r) {
                var i = !0, n = !0;
                if ("function" != typeof t) throw new TypeError(Rr);
                return $r(r) && (i = "leading" in r ? !!r.leading : i, n = "trailing" in r ? !!r.trailing : n), 
                qr(t, e, {
                    leading: i,
                    maxWait: e,
                    trailing: n
            ...
            var hi = function(t, e, r) {
                ...
                return e = fi(e) || 0, ui(r) && (u = !!r.leading, o = (f = "maxWait" in r) ? ai(fi(r.maxWait) || 0, e) : o, 
                h = "trailing" in r ? !!r.trailing : h), b.cancel = function() {
                    void 0 !== a && clearTimeout(a), l = 0, i = c = n = a = void 0;
                }, b.flush = function() {
            ...
            var $i, Yi = function(t) {
                ...
                function t(t, e, r, i) {
                    return this.x = t, this.y = e, this.width = r, this.height = i, this.top = this.y, 
                ...
                var r = getComputedStyle(t), i = Qi(t) && t.ownerSVGElement && t.getBBox(), n = !nn && "border-box" === r.boxSizing, o = rn.test(r.writingMode || ""), s = !i && en.test(r.overflowY || ""), a = !i && en.test(r.overflowX || ""), c = i ? 0 : on(r.paddingTop), l = i ? 0 : on(r.paddingRight), u = i ? 0 : on(r.paddingBottom), f = i ? 0 : on(r.paddingLeft), h = i ? 0 : on(r.borderTopWidth), d = i ? 0 : on(r.borderRightWidth), p = i ? 0 : on(r.borderBottomWidth), v = f + l, g = c + u, b = (i ? 0 : on(r.borderLeftWidth)) + d, y = h + p, m = a ? t.offsetHeight - y - t.clientHeight : 0, x = s ? t.offsetWidth - b - t.clientWidth : 0, E = n ? v + b : 0, w = n ? g + y : 0, S = i ? i.width : on(r.width) - E - x, O = i ? i.height : on(r.height) - w - m, k = S + v + x + b, A = O + g + m + y, T = Yi({
                ...
                var e = cn(t);
                this.target = t, this.contentRect = e.contentRect, this.borderBoxSize = Yi([ e.borderBoxSize ]), 
                this.contentBoxSize = Yi([ e.contentBoxSize ]), this.devicePixelContentBoxSize = Yi([ e.devicePixelContentBoxSize ]);
            }, fn = function(t) {
                if (Ki(t)) return 1 / 0;
                ...
                return t.prototype.run = function(t) {
                    ...
                    this.observe(), mn.forEach((function(e) {
                ...
                return t.connect = function(t, e) {
                    ...
                    Tn(i.observationTargets, e) < 0 && (n && Hi.push(i), i.observationTargets.push(new On(e, r && r.box)), 
                    Sn(1), wn.schedule());
                }, t.unobserve = function(t, e) {
                    var r = An.get(t), i = Tn(r.observationTargets, e), n = 1 === r.observationTargets.length;
                    i >= 0 && (n && Hi.splice(Hi.indexOf(r), 1), r.observationTargets.splice(i, 1), 
                    Sn(-1));
            ...
            In = /b*/g, Dn.call(Nn, "a"), Dn.call(In, "a"), 0 !== Nn.lastIndex || 0 !== In.lastIndex), Xn = void 0 !== /()??/.exec("")[1];
            (Vn || Xn) && (Fn = function(t) {
                var e, r, i, n, o = this;
                return Xn && (r = new RegExp("^" + o.source + "$(?!\\s)", Bn.call(o))), Vn && (e = o.lastIndex), 
                i = Dn.call(o, t), Vn && i && (o.lastIndex = o.global ? i.index + i[0].length : e), 
            ...
            var lo = function() {
                function t(e, r) {
                    ...
                    this.onScroll = function() {
                        ...
                        i.mouseX = t.clientX, i.mouseY = t.clientY, (i.axis.x.isOverflowing || i.axis.x.forceVisible) && i.onMouseMoveForAxis("x"), 
                        (i.axis.y.isOverflowing || i.axis.y.forceVisible) && i.onMouseMoveForAxis("y");
                    }, this.onMouseLeave = function() {
                        i.onMouseMove.cancel(), (i.axis.x.isOverflowing || i.axis.x.forceVisible) && i.onMouseLeaveForAxis("x"), 
                        (i.axis.y.isOverflowing || i.axis.y.forceVisible) && i.onMouseLeaveForAxis("y"), 
                        i.mouseX = -1, i.mouseY = -1;
                    }, this.onWindowResize = function() {
                        i.scrollbarWidth = i.getScrollbarWidth(), i.hideNativeScrollbar();
                    }, this.hideScrollbars = function() {
                        i.axis.x.track.rect = i.axis.x.track.el.getBoundingClientRect(), i.axis.y.track.rect = i.axis.y.track.el.getBoundingClientRect(), 
                        i.isWithinBounds(i.axis.y.track.rect) || (i.axis.y.scrollbar.el.classList.remove(i.classNames.visible), 
                        i.axis.y.isVisible = !1), i.isWithinBounds(i.axis.x.track.rect) || (i.axis.x.scrollbar.el.classList.remove(i.classNames.visible), 
                        ...
                        (e || r) && (t.preventDefault(), t.stopPropagation(), "mousedown" === t.type && (e && (i.axis.x.scrollbar.rect = i.axis.x.scrollbar.el.getBoundingClientRect(), 
                        ...
                        var r = i.axis[i.draggedAxis].track, n = r.rect[i.axis[i.draggedAxis].sizeAttr], o = i.axis[i.draggedAxis].scrollbar, s = i.contentWrapperEl[i.axis[i.draggedAxis].scrollSizeAttr], a = parseInt(i.elStyles[i.axis[i.draggedAxis].sizeAttr], 10);
                        ...
                        c = i.isRtl && t.getRtlHelpers().isRtlScrollingInverted ? -c : c), i.contentWrapperEl[i.axis[i.draggedAxis].scrollOffsetAttr] = c;
                    }, this.onEndDrag = function(t) {
                        var e = oo(i.el), r = no(i.el);
                        t.preventDefault(), t.stopPropagation(), i.el.classList.remove(i.classNames.dragging), 
                        e.removeEventListener("mousemove", i.drag, !0), e.removeEventListener("mouseup", i.onEndDrag, !0), 
                        i.removePreventClickId = r.setTimeout((function() {
                            e.removeEventListener("click", i.preventClick, !0), e.removeEventListener("dblclick", i.preventClick, !0), 
                    ...
                    this.onMouseMove = Gr(this.onMouseMove.bind(this), 64), this.hideScrollbars = hi(this.hideScrollbars.bind(this), this.options.timeout), 
                ...
                return e.init = function() {
                    t.instances.set(this.el, this), Yt && (this.initDOM(), this.setAccessibilityAttributes(), 
                    ...
                    var e = this.heightAutoObserverEl.offsetHeight <= 1, r = this.heightAutoObserverEl.offsetWidth <= 1, i = this.contentEl.offsetWidth, n = this.contentWrapperEl.offsetWidth, o = this.elStyles.overflowX, s = this.elStyles.overflowY;
                    this.contentEl.style.padding = this.elStyles.paddingTop + " " + this.elStyles.paddingRight + " " + this.elStyles.paddingBottom + " " + this.elStyles.paddingLeft, 
                    this.wrapperEl.style.margin = "-" + this.elStyles.paddingTop + " -" + this.elStyles.paddingRight + " -" + this.elStyles.paddingBottom + " -" + this.elStyles.paddingLeft;
                    var a = this.contentEl.scrollHeight, c = this.contentEl.scrollWidth;
                    this.contentWrapperEl.style.height = e ? "auto" : "100%", this.placeholderEl.style.width = r ? i + "px" : "auto", 
                    this.placeholderEl.style.height = a + "px";
                    var l = this.contentWrapperEl.offsetHeight;
                    this.axis.x.isOverflowing = c > i, this.axis.y.isOverflowing = a > l, this.axis.x.isOverflowing = "hidden" !== o && this.axis.x.isOverflowing, 
                    ...
                    this.axis.x.isOverflowing = this.axis.x.isOverflowing && c > n - f, this.axis.y.isOverflowing = this.axis.y.isOverflowing && a > l - u, 
                    ...
                    return e = Math.max(~~(n * i), this.options.scrollbarMinSize), this.options.scrollbarMaxSize && (e = Math.min(e, this.options.scrollbarMaxSize)), 
                    e;
                }, e.positionScrollbar = function(e) {
                    if (void 0 === e && (e = "y"), this.axis[e].isOverflowing) {
                        var r = this.contentWrapperEl[this.axis[e].scrollSizeAttr], i = this.axis[e].track.el[this.axis[e].offsetSizeAttr], n = parseInt(this.elStyles[this.axis[e].sizeAttr], 10), o = this.axis[e].scrollbar, s = this.contentWrapperEl[this.axis[e].scrollOffsetAttr], a = (s = "x" === e && this.isRtl && t.getRtlHelpers().isRtlScrollingInverted ? -s : s) / (r - n), c = ~~((i - o.size) * a);
                    ...
                    this.axis[e].dragOffset = o - n.rect[this.axis[e].offsetAttr], this.draggedAxis = e, 
                    ...
                    if (void 0 === e && (e = "y"), this.options.clickOnTrack) {
                        ...
                        var n = this.axis[e].scrollbar.rect[this.axis[e].offsetAttr], o = parseInt(this.elStyles[this.axis[e].sizeAttr], 10), s = this.contentWrapperEl[this.axis[e].scrollOffsetAttr], a = ("y" === e ? this.mouseY - n : this.mouseX - n) < 0 ? -1 : 1, c = -1 === a ? s - o : s + o;
                        !function t() {
                            var n, o;
                            -1 === a ? s > c && (s -= r.options.clickOnTrackSpeed, r.contentWrapperEl.scrollTo(((n = {})[r.axis[e].offsetAttr] = s, 
                            n)), i.requestAnimationFrame(t)) : s < c && (s += r.options.clickOnTrackSpeed, r.contentWrapperEl.scrollTo(((o = {})[r.axis[e].offsetAttr] = s, 
                            o)), i.requestAnimationFrame(t));
                        }();
                    }
            ...
            return lo.defaultOptions = {
                ...
                this.initDOMLoadedElements = this.initDOMLoadedElements.bind(this), "undefined" != typeof MutationObserver && (this.globalObserver = new MutationObserver(lo.handleMutations), 
        ...
        class InputMask {
            constructor(props, data = null) {
                ...
                if (this.config.init) {
                    ...
                    } else this.setLogging("Нет ни одной маски. Сплю...zzZZZzZZz...");
                }
            }
            setActions() {
            ...
            maskActions(e) {
                ...
                if (targetElement.closest("._mask-init")) {
                    ...
                    if (input.selectionStart > inputMask.length) e.preventDefault();
                }
            }
            setLogging(message) {
        ...
        if (window.innerWidth > 991.98 && window.innerWidth < 1315) {
            const wrapper = document.querySelector(".wrapper");
            const bodyHeader = document.querySelector(".body-header");
            wrapper.setAttribute("data-sticky", "true");
            wrapper.setAttribute("data-sticky-top", "27");
            bodyHeader.setAttribute("data-sticky-item", "true");
            const infoTopHeaderItems = document.querySelectorAll(".top-header__item ");
            if (infoTopHeaderItems.length) infoTopHeaderItems.forEach((infoTopHeaderItem => {
                const infoTopHeaderText = infoTopHeaderItem.querySelector(".top-header__item  .info-item__text");
                const infoTopHeaderTextValue = infoTopHeaderText.innerHTML;
                infoTopHeaderItem.setAttribute("data-tippy-content", `${infoTopHeaderTextValue}`);
            }));
        }
        initTippy();
        ...
        if (document.querySelector(".offers__body") && window.innerWidth < 479.98) {
            const offersBody = document.querySelector(".offers__body");
            offersBody.classList.add("offers__swiper");
        }
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".offers__slider") && window.innerWidth < 479.98) {
                const dotts = document.querySelector(".offers__slider .dotts");
                const elementStart = dotts.querySelector(".dotts__bullet_start");
                const elementMid = dotts.querySelector(".dotts__bullet_middle");
                const elementEnd = dotts.querySelector(".dotts__bullet_end");
                new core(".offers__slider", {
                    ...
                    on: {
                        reachEnd: () => {
                            elementEnd.classList.add("_active");
                            elementMid.classList.remove("_active");
                        },
                        reachBeginning: () => {
                            elementStart.classList.add("_active");
                            elementMid.classList.remove("_active");
                        },
                        fromEdge: () => {
                            elementStart.classList.remove("_active");
                            elementEnd.classList.remove("_active");
                            elementMid.classList.add("_active");
                        }
                    }
                });
            }
            if (document.querySelector(".universal__body")) {
                const thumbsUniversal = new core(".thumbs-universal", {
                    modules: [ Controller ],
                    loop: true,
                    slidesPerView: 1,
                    spaceBetween: 30,
                ...
                const universalSlider = new core(".universal__slider", {
                    modules: [ Navigation, EffectFade, Keyboard, Thumb, Controller ],
                    navigation: {
                        nextEl: ".universal-arrow-next",
                        prevEl: ".universal-arrow-prev"
                    },
                    effect: "fade",
                    fadeEffect: {
                        crossFade: true
                ...
                if (window.innerWidth < 767.98) {
                    universalSlider.thumbs = false;
                    universalSlider.controller.control = thumbsUniversal;
                    thumbsUniversal.controller.control = universalSlider;
                }
            }
            if (document.querySelector(".testimonials__slider")) {
                const dotts = document.querySelector(".testimonials .dotts");
                const elementStart = dotts.querySelector(".dotts__bullet_start");
                const elementMid = dotts.querySelector(".dotts__bullet_middle");
                const elementEnd = dotts.querySelector(".dotts__bullet_end");
                new core(".testimonials__slider", {
                    modules: [ Navigation, Keyboard ],
                    navigation: {
                        prevEl: ".testimonials__wrapper .slider-arrow-prev",
                        nextEl: ".testimonials__wrapper .slider-arrow-next"
                    },
                    keyboard: {
                        enabled: true,
                        onlyInViewport: false
            ...
            if (document.querySelector(".sertificate__slider")) new core(".sertificate__slider", {
                modules: [ Navigation, Keyboard ],
                navigation: {
                    prevEl: ".sertificate__wrapper .slider-arrow-prev",
                    nextEl: ".sertificate__wrapper .slider-arrow-next"
                },
                keyboard: {
                    enabled: true,
                    onlyInViewport: false
            ...
            if (document.querySelector(".card-content__left")) {
                const thumbsCard = new core(".card-slider-thumbs__body", {
                    modules: [ Navigation, Keyboard ],
                    slidesPerView: 3,
                    spaceBetween: 40,
                    speed: 500,
                ...
                const dotts = document.querySelector(".card-content__wrapper .dotts");
                const elementStart = dotts.querySelector(".dotts__bullet_start");
                const elementMid = dotts.querySelector(".dotts__bullet_middle");
                const elementEnd = dotts.querySelector(".dotts__bullet_end");
                new core(".card-content-slider", {
                    modules: [ Navigation, Thumb, Keyboard ],
                    navigation: {
                        prevEl: ".card-content__wrapper .slider-arrow-prev",
                        nextEl: ".card-content__wrapper .slider-arrow-next"
                    },
                    thumbs: {
                        swiper: thumbsCard
                    },
            ...
            if (document.querySelector(".simular-products__slider")) {
                const dotts = document.querySelector(".simular-products__wrapper .dotts");
                const elementStart = dotts.querySelector(".dotts__bullet_start");
                const elementMid = dotts.querySelector(".dotts__bullet_middle");
                const elementEnd = dotts.querySelector(".dotts__bullet_end");
                new core(".simular-products__slider", {
                    modules: [ Navigation, Keyboard ],
                    navigation: {
                        prevEl: ".simular-products__wrapper .slider-arrow-prev",
                        nextEl: ".simular-products__wrapper .slider-arrow-next"
                    },
                    keyboard: {
                        enabled: true,
                        onlyInViewport: false
            ...
            if (document.querySelector(".blog-more__slider")) {
                const dotts = document.querySelector(".blog-more__wrapper .dotts");
                const elementStart = dotts.querySelector(".dotts__bullet_start");
                const elementMid = dotts.querySelector(".dotts__bullet_middle");
                const elementEnd = dotts.querySelector(".dotts__bullet_end");
                new core(".blog-more__slider", {
                    modules: [ Navigation, Keyboard ],
                    navigation: {
                        prevEl: ".blog-more__wrapper .slider-arrow-prev",
                        nextEl: ".blog-more__wrapper .slider-arrow-next"
                    },
                    keyboard: {
                        enabled: true,
                        onlyInViewport: false
            ...
            function pageNavigationAction(e) {
                if ("click" === e.type) {
                    ...
                    if (targetElement.closest("[data-goto]")) {
                        ...
                        gotoblock_gotoBlock(`#${gotoLink.dataset.goto}`, noHeader, gotoSpeed);
                        e.preventDefault();
                    }
                } else if ("watcherCallback" === e.type) if (e.detail) {
        ...
        function stickyBlock() {
            ...
            function stickyBlockItem(stickyParent, stickyConfig) {
                ...
                const startPosition = stickyBlockItem.offsetHeight;
                document.addEventListener("windowScroll", (function(e) {
                    ...
                    if (offsetTop + stickyConfig.bottom + stickyBlockItem.offsetHeight < window.innerHeight) {
                        ...
                        if (startPosition === startPosition + scrollY) {
                            stickyItemValues.position = "relative";
                            stickyItemValues.bottom = "auto";
                            stickyItemValues.top = "0px";
                            stickyItemValues.left = "0px";
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                ...
                if (window.innerWidth > 991 && isMobile.any()) {
                    if (targetElement.classList.contains("menu-body-header__item_sub-menu") || targetElement.closest(".menu-body-header__item_sub-menu")) {
                        targetElement.closest(".menu-body-header__item_sub-menu").classList.toggle("_active");
                        e.preventDefault();
                    }
                    if (!targetElement.closest(".menu-body-header__item_sub-menu") && document.querySelectorAll(".menu-body-header__item_sub-menu._active").length > 0) _removeClasses(document.querySelectorAll(".menu-body-header__item_sub-menu"), "_active");
                }
            }
            const switchBoxes = document.querySelectorAll(".switch-box");
            if (switchBoxes.length) switchBoxes.forEach((switchBox => {
                switchBox.addEventListener("click", (() => {
                    switchBox.classList.toggle("_active");
                }));
            }));
            if (document.querySelector(".order-products__list") && window.innerWidth > 991.98) new SimpleBar(document.querySelector(".order-products__list"));
            const formSizes = document.querySelector(".card-form__size");
            if (formSizes) {
                const inputWidth = formSizes.querySelector(".card-form__input_width");
                const inputHeight = formSizes.querySelector(".card-form__input_height");
                const valueWidth = formSizes.querySelector(".width");
                const valueHeight = formSizes.querySelector(".height");
                inputWidth.addEventListener("keyup", (() => {
                    if (inputWidth.value >= 30 && inputWidth.value <= 160) valueWidth.innerHTML = `${inputWidth.value}`;
                }));
                inputHeight.addEventListener("keyup", (() => {
                    if (inputHeight.value >= 30 && inputHeight.value <= 160) valueHeight.innerHTML = `${inputHeight.value}`;
                }));
            }
        };
        isWebp();
